...
export class FixedSeedGenerator {
    private seedService: DebugSeedService;

    constructor() {
        this.seedService = new DebugSeedService();
    }
        ...
        try {
            ...
            for (const user of users) {
                ...
                if (result.success && result.userId) {
                    ...
                    console.log(`✅ Created user: ${user.email} (ID: ${result.userId})`);
                } else {
                    errorCount++;
            ...
            const summary = `Seed completed: ${successCount} successful, ${errorCount} failed out of ${totalOperations} total`;
            console.log(`\n📊 ${summary}`);
