...
ALTER TABLE profile ADD CONSTRAINT fk_profile_auth_users FOREIGN KEY (id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
-- These will be bypassed when using service role key

-- Schema creation completed successfully
-- Next: Create seed data insertion functions
